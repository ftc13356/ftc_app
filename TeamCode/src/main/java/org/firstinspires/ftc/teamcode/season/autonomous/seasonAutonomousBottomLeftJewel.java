package org.firstinspires.ftc.teamcode.season.autonomous;
...
@Autonomous(name = " 16-17 Season Autonomous Bottom Left Jewel (HouseB)")
@Disabled
public class seasonAutonomousBottomLeftJewel extends seasonAutonomousFrame {
